...
execute unless block ~ ~ ~ #pkmoves:not_vaultable if block ~ ~1 ~ #pkmoves:not_vaultable run scoreboard players set walltip pkmoves.global 1
execute unless block ~ ~ ~ #pkmoves:not_vaultable if block ^ ^ ^1 #pkmoves:not_vaultable run scoreboard players set obstacle pkmoves.global 1
