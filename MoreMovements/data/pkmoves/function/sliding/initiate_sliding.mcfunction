...
execute rotated ~ 0 anchored eyes positioned ^ ^ ^2 run summon item_display ~ ~ ~ {Tags:["pkmoves.init","pkmoves.slide_hitbox"],Passengers:[{id:"minecraft:shulker",NoGravity:1b,Silent:1b,Invulnerable:1b,DeathLootTable:"asdasd",NoAI:1b,AttachFace:1b,Color:14b}]}
