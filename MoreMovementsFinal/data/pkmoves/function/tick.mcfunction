...
execute as @a if score @s pkmoves.sliding_cd matches 30.. if score @s pkmoves.jump matches 1.. run scoreboard players set launch_power motion_library.variables 750
execute as @a if score @s pkmoves.sliding_cd matches 30.. if score @s pkmoves.jump matches 1.. at @s rotated ~ -15 run function manipulation:api/launch_facing
...
execute as @a at @s unless block ~ ~-0.1 ~ #pkmoves:not_solid run execute at @s run particle minecraft:entity_effect{color:[0.9960784313725490196078431372549,0.9921568627450980392156862745098,1.7568627461,1.0]} ~ ~ ~ 0 0 0 1 0 force @s
