...
execute unless block ~ ~ ~0.6 #pkmoves:not_wall unless block ~ ~0.5 ~0.6 #pkmoves:not_wall run scoreboard players set iswall pkmoves.global 1
execute unless block ~0.6 ~ ~ #pkmoves:not_wall unless block ~0.6 ~0.5 ~ #pkmoves:not_wall run scoreboard players set iswall pkmoves.global 1
execute unless block ~ ~ ~-0.6 #pkmoves:not_wall unless block ~ ~0.5 ~-0.6 #pkmoves:not_wall run scoreboard players set iswall pkmoves.global 1
execute unless block ~-0.6 ~ ~ #pkmoves:not_wall unless block ~-0.6 ~0.5 ~ #pkmoves:not_wall run scoreboard players set iswall pkmoves.global 1
