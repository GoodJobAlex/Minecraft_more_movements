...
execute if score vmt pkmoves.global matches ..-60 run return fail
execute if score vmt pkmoves.global matches ..-30 at @s unless block ~ ~-2 ~ #pkmoves:not_solid run return fail
return 1
