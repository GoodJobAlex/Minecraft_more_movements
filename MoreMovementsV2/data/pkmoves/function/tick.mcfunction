...
execute as @a if score @s pkmoves.sliding_cd matches 30.. if score @s pkmoves.jump matches 1.. run scoreboard players set launch_power motion_library.variables 900
execute as @a if score @s pkmoves.sliding_cd matches 30.. if score @s pkmoves.jump matches 1.. at @s rotated ~ -10 run function manipulation:api/launch_facing
